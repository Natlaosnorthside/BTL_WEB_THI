<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sachkynangsong.aspx.cs" Inherits="BTL2.Sachkynangsong" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sách Kỹ Năng Sống</title>
    <link href="CSS/Sachkynangsong.css" rel="stylesheet" />
...
<body>
            ...
            <div>
                <form runat="server">
                 <input type="text" name="search" placeholder="Search" runat="server" id="search_text"/>
                    <button type="submit" runat="server"  id="search_button" onserverclick="search_button_ServerClick" >Tìm</button>
                </form>
           </div>
		</div>
            </div>
	...
	<div class="up">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>TRANG CHỦ</strong></a> / <a href="Sachkynangsong.aspx"><strong>Sách Kỹ Năng Sống</strong></a>
        </div>
    </div>
    <div class="container">
        ...
        <div class="sidebar_two">
            <div class="sanpham">
                <asp:ListView ID="sachkynangsong1" runat="server">
                    <ItemTemplate>
