...
<body>
    ...
    <form action="Dangnhap.aspx" runat="server" method="post" onsubmit=" return check()">
        <div id="dangnhap-tt">
            ...
            <div class="form-tt">
            <span>Tài khoản</span>
            <input type="text" name="user" id="user" value="" required /><lable id="loi_tk" runat="server"></lable>
            </div>
             <br />
            <div class="form-tt">
            <span>Mật khẩu</span>
            <input type="password" name="pass" id="pass" value="" required /><lable id="loi_mk" runat="server"></lable>
				<br />
				<lable id="loi_mk1" runat="server"></lable>
            </div>
            <br />
			<div class="form-tt">
            <button id="btnsubmit" runat="server" value="Đăng nhập">Đăng nhập</button>
		...
		<div class="footter_top">
			...
			<div class="Lienket">
				...
				<ul>
					...
					<li><a href="New.aspx">Dữ liệu ng dùng</a></li>
				</ul>
			</div>
		</div>
